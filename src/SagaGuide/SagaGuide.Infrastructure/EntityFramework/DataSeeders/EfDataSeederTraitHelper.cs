...
public static class EfDataSeederTraitHelper
{
    public static List<Trait> GetAllTraits()
    {
        var traits = new List<Trait>();
        traits.AddRange(GetAdvantages());
        traits.AddRange(GetDisadvantages());
        traits.Add(GetAllyTrait());
        return traits;
    }

    private static List<Trait> GetAdvantages()
    {
        const string json = @"[{
	...
	},
	{
        ...
        return JsonConverterWrapper.Deserialize<List<Trait>>(json, jsonSettings)!;
    }

    private static List<Trait> GetDisadvantages()
    {
        const string json = @"
        [
			{
    ...
    private static Trait GetAllyTrait()
    {
        const string json = @"
			{
        ...
        var jsonSettings = JsonSettingsWrapper.CreateGcsMasterLibrarySettings();
        return JsonConverterWrapper.Deserialize<Trait>(json, jsonSettings)!;
    }
}